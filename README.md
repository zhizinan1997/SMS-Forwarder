...
| 💬 接收消息 (iOS 风格) | 📤 发送短信 |
| :---: | :---: |
| ![接收短信](images/jieshouduanxin.jpg) | ![发送短信](images/fasongxinxi.jpg) |
...
| 硬件实拍 | 推荐方案 |
| :---: | :--- |
| ![硬件展示](images/device.jpg) | **Air780E 系列开发板**<br>· 4G 全网通物联网模块<br>· 支持 LuatOS 二次开发<br>· [🛒 点击前往淘宝购买](https://e.tb.cn/h.7gu14ADyoa5Ur7B?tk=B7RefAkj85l) |
